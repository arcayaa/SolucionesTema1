...
#La diferencia es que en un data frame le llama al animal de una manera y en el otro de una forma distinta, pero se refieren al mismo animal
...
#Observamos que presentan practicamente el mismo comportamiento, si podriamos decir que siguen una distribucion Gaussiana ya que los puntosse encuentran dentro de las lineas
```
...
#Tengo instaladas 227 librerias
